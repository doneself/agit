 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         '>4tfOwH{(vze,%f/Kf3EkLUUu@RMKZNq?XU^VD$DYL{M^$.+~=y%^|c T9rEp==x');
define('SECURE_AUTH_KEY',  '*>A@S,yZAv8X:WKv]i$@!{gL@DV?|o8LD^I_u8xWm/>#taUT?o[dM(rLlG)3Ce:-');
define('LOGGED_IN_KEY',    'V1@~vf.%Q#?<BRVULAHV<ol=GW_Z_)`!3IgBj;oZ->Zjg656^R{gPxvg88@,7=G%');
define('NONCE_KEY',        'sflwy|7ZcFc ;wr#.CoQL#M.=?S(TFb@GLumwPlMY|y@.=YGm[Px2I_IsDFn!IHD');
define('AUTH_SALT',        'GNj mY7]KCxva0yv#9@W;2EFW.|!?Kb7s>jNiEB[E)Yi7x$2Wm<?d!0<$qBO{-:<');
define('SECURE_AUTH_SALT', 'Xgh=1D=mHE)lKhG-.<T491*XxFLHN0NwuLJ$uXqj|F7v(^JL5x<*IQ,v=:ZmGYKk');
define('LOGGED_IN_SALT',   '68aq&gh(urwfX`wp5iMtjp}hih<F$,JDqno<6mL.~A~%5)3{{UQzfKR.yJy+.TW}');
define('NONCE_SALT',       'e-#3V,~LviD RJ*R^I {?RFFbB?B}<eO6Bj}=9whIE$Kp@`] #Re^]vyN6&=ZEFA');
